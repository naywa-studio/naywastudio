...
- RUBRIQUES MÊLÉES : un CV titre parfois une rubrique qui contient DEUX choses, dont une seule a un champ dédié — « LANGUES ET CENTRES D'INTÉRÊT », « FORMATION ET CERTIFICATIONS », « COMPÉTENCES ET LOISIRS ». Découpe-la : la partie prévue par le schéma va dans son champ, LE RESTE vient ici sous son propre intitulé. Ne considère jamais une rubrique comme traitée parce que tu en as rangé la moitié — c'est ainsi qu'on a perdu les centres d'intérêt d'un candidat dont le CV disait « LANGUES ET CENTRES D'INTÉRÊT ».
