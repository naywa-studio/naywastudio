...
export const brand = {
  ...
  /** Italique d'accent pour un mot dans un titre (« décidez »). Fraunces
   *  italique — même serif haut-contraste que les titres, conforme à la
   *  charte v2.0 (l'accent n'est PAS une autre police). */
