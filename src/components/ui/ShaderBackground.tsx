...
export function ShaderBackground() {
  ...
  // Band 1 — steep diagonal, y left≈0.12 → y right≈0.40, height≈0.13
  //   Deep S-curve: CP1 pushed well above start, CP2 pulled past midline
  const b1F = [
    'M0,0.12 C0.15,-0.05 0.85,0.30 1,0.40 L1,0.53 C0.85,0.43 0.15,0.08 0,0.25 Z',
    'M0,0.13 C0.15,-0.03 0.85,0.28 1,0.41 L1,0.54 C0.85,0.41 0.15,0.10 0,0.26 Z',
    'M0,0.12 C0.15,-0.05 0.85,0.30 1,0.40 L1,0.53 C0.85,0.43 0.15,0.08 0,0.25 Z',
  ].join(';')
  const b1T = [
    'M0,0.12 C0.15,-0.05 0.85,0.30 1,0.40',
    'M0,0.13 C0.15,-0.03 0.85,0.28 1,0.41',
    'M0,0.12 C0.15,-0.05 0.85,0.30 1,0.40',
  ].join(';')
  const b1B = [
    'M0,0.25 C0.15,0.08 0.85,0.43 1,0.53',
    'M0,0.26 C0.15,0.10 0.85,0.41 1,0.54',
    'M0,0.25 C0.15,0.08 0.85,0.43 1,0.53',
  ].join(';')

  // Band 2 — steep diagonal, y left≈0.36 → y right≈0.58, height≈0.13
  const b2F = [
    'M0,0.36 C0.18,0.22 0.82,0.50 1,0.58 L1,0.71 C0.82,0.63 0.18,0.35 0,0.49 Z',
    'M0,0.35 C0.18,0.24 0.82,0.48 1,0.59 L1,0.72 C0.82,0.61 0.18,0.37 0,0.48 Z',
    'M0,0.36 C0.18,0.22 0.82,0.50 1,0.58 L1,0.71 C0.82,0.63 0.18,0.35 0,0.49 Z',
  ].join(';')
  const b2T = [
    'M0,0.36 C0.18,0.22 0.82,0.50 1,0.58',
    'M0,0.35 C0.18,0.24 0.82,0.48 1,0.59',
    'M0,0.36 C0.18,0.22 0.82,0.50 1,0.58',
  ].join(';')
  const b2B = [
    'M0,0.49 C0.18,0.35 0.82,0.63 1,0.71',
    'M0,0.48 C0.18,0.37 0.82,0.61 1,0.72',
    'M0,0.49 C0.18,0.35 0.82,0.63 1,0.71',
  ].join(';')
