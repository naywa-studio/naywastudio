 ...
 *
 * Un seul preset (diagonales / bas-gauche → haut-droite) appliqué sur
 * toutes les pages publiques et l'app. Choix produit : cohérence visuelle
 * d'abord, pas de variation par page.
 */
export function ShaderBackground() {
  ...
  useEffect(() => {
    ...
    const fragSrc = `
      ...
      void main() {
        ...
        vec3 mist     = vec3(0.965, 0.956, 0.988);
        vec3 softV    = vec3(0.855, 0.827, 0.949);
        vec3 violet   = vec3(0.722, 0.682, 0.871);
  ...
  // Bandes diagonales animées (objectBoundingBox 0..1).
  const b1F = 'M0,0.50 C0.15,0.62 0.85,0.16 1,0.20 L1,0.33 C0.85,0.29 0.15,0.75 0,0.63 Z;M0,0.51 C0.15,0.60 0.85,0.18 1,0.21 L1,0.34 C0.85,0.31 0.15,0.73 0,0.64 Z;M0,0.50 C0.15,0.62 0.85,0.16 1,0.20 L1,0.33 C0.85,0.29 0.15,0.75 0,0.63 Z'
  const b1T = 'M0,0.50 C0.15,0.62 0.85,0.16 1,0.20;M0,0.51 C0.15,0.60 0.85,0.18 1,0.21;M0,0.50 C0.15,0.62 0.85,0.16 1,0.20'
  const b1B = 'M0,0.63 C0.15,0.75 0.85,0.29 1,0.33;M0,0.64 C0.15,0.73 0.85,0.31 1,0.34;M0,0.63 C0.15,0.75 0.85,0.29 1,0.33'
  const b2F = 'M0,0.67 C0.15,0.79 0.85,0.33 1,0.37 L1,0.50 C0.85,0.46 0.15,0.92 0,0.80 Z;M0,0.68 C0.15,0.77 0.85,0.35 1,0.38 L1,0.51 C0.85,0.48 0.15,0.90 0,0.81 Z;M0,0.67 C0.15,0.79 0.85,0.33 1,0.37 L1,0.50 C0.85,0.46 0.15,0.92 0,0.80 Z'
  const b2T = 'M0,0.67 C0.15,0.79 0.85,0.33 1,0.37;M0,0.68 C0.15,0.77 0.85,0.35 1,0.38;M0,0.67 C0.15,0.79 0.85,0.33 1,0.37'
  const b2B = 'M0,0.80 C0.15,0.92 0.85,0.46 1,0.50;M0,0.81 C0.15,0.90 0.85,0.48 1,0.51;M0,0.80 C0.15,0.92 0.85,0.46 1,0.50'
