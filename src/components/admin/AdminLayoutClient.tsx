...
/**
 * Chrome UI de la console admin Naywa (header + onglets + contexte
 * `useAdmin()`). Le GARDE-FOU d'accès (is_admin) est côté serveur dans
 * `src/app/admin/layout.tsx`, qui rend ce composant en enfant seulement
 * après vérification — ce composant ne s'exécute donc jamais pour un
 * non-admin. La re-vérification client ci-dessous est un filet UX
 * supplémentaire (ex. session qui expire pendant la navigation côté
 * client), pas la barrière de sécurité.
 *
