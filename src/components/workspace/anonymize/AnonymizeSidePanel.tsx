...
const copy = {
  fr: {
    ...
    candidateSummaryHint: "Le résumé figurant sur son CV, remis en forme au parsing. Il parle du candidat, pas de la mission.",
    watermark: "Filigrane",
  ...
  en: {
    ...
    candidateSummaryHint: "The summary from their own CV, tidied up at parsing. It describes the candidate, not the job.",
    watermark: "Watermark",
