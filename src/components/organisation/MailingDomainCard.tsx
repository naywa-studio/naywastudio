...
const copy = {
  fr: {
    ...
    stUnknown: "Non lu",
    foundLabel: "Trouvé :",
    allPublished: "Tous vos enregistrements sont visibles. Il reste à votre hébergeur et à notre fournisseur de se synchroniser — cela prend de quelques minutes à quelques heures. Revenez vérifier.",
  ...
  en: {
    ...
    stUnknown: "Not read",
    foundLabel: "Found:",
    allPublished: "All your records are visible. Your DNS host and our provider now need to sync — that takes a few minutes to a few hours. Come back and verify.",
