  ...
  fr: [
    ...
    },
    {
      ...
      content: [
        ...
        "• **Resend** : envoi des emails de service (mail.naywastudio.com).",
        "• **Amazon Web Services** : envoi et réception des emails adressés aux candidats (service SES, région Europe/Irlande).",
  ...
  en: [
    ...
    },
    {
      ...
      content: [
        ...
        "• **Resend**: sending service emails (mail.naywastudio.com).",
        "• **Amazon Web Services**: sending and receiving candidate emails (SES, Europe/Ireland region).",
