        ...
        {rows.length === 0 ? (
          ...
          <div style={{ flex: 1, minHeight: 0, marginTop: 14, overflow: "auto", paddingBottom: 14 }}>
            <div style={{
              ...
              <div style={{ ...headerCellStyle, color: "var(--nw-text-muted)" }}>{t.missionColumn}</div>
              {ACTIVE_STAGES.map((s) => (
...
function Card({
  ...
  return (
    ...
    >
      ...
      <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", gap: 6, marginTop: 2 }}>
        <span style={{ fontSize: 10.5, color: "var(--nw-text-muted)" }}>{timeAgo(row.updated_at, lang)}</span>
