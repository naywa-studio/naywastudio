...
const copy = {
  fr: {
    ...
    clientFeedbackHint: "Notez ici le retour du client sur ce candidat. Le verdict (présenté / recruté / écarté) se gère via l'étape de la shortlist. Privé — aucun message n'est envoyé.",
  ...
  en: {
    ...
    clientFeedbackHint: "Record the client's feedback on this candidate here. The verdict (presented / recruited / dropped) is managed via the shortlist stage. Private — no message is sent.",
