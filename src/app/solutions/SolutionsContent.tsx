...
const content = {
  ...
  en: {
    ...
    security: [
      "European hosting (Vercel Paris, Supabase Frankfurt).",
      "Strict per-organization isolation via Postgres RLS.",
      "No model training on your data.",
      "Delete your talent pool at any time, from your organization console.",
    ],
