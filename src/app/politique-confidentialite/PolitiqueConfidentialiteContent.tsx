  ...
  en: [
    ...
    },
    {
      ...
      content: [
        ...
        "**Billing data**",
        "Organization name, billing address, VAT number if applicable, subscription status. No banking data ever passes through Naywa Studio: it is processed directly by Stripe.",
      ],
    },
    {
      ...
      content: [
        ...
        "**Billing**: managing your subscription, the contract, and applicable VAT.",
