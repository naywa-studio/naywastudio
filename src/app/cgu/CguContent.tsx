...
const SECTIONS: Record<"fr" | "en", LegalSection[]> = {
  fr: [
    ...
    },
    {
      ...
      content: [
        "Le service est commercialisé **par personne autorisée** (siège), selon un tarif dégressif au nombre de personnes. La **Suite Pricing Syntec** est une **option** facturée séparément, à prix unique quel que soit le nombre de personnes ; elle peut être activée ou retirée à tout moment et n'est pas requise pour utiliser le service. L'**option Mailing**, qui permet d'écrire aux candidats depuis la messagerie ou le domaine de l'organisation, suit les mêmes règles : prix unique, activable et retirable à tout moment, non requise. La grille tarifaire en vigueur est publiée sur la page Tarifs.",
  ...
  en: [
    ...
    },
    {
      ...
      content: [
        "The service is sold **per authorized person** (seat), at a price that decreases as the number of people grows. The **Suite Pricing Syntec** is an **option** billed separately, at a flat price regardless of the number of people; it can be activated or removed at any time and is not required to use the service. The **Mailing option**, which allows writing to candidates from the organisation's own mailbox or domain, follows the same rules: flat price, activated or removed at any time, not required. The current pricing grid is published on the Pricing page.",
