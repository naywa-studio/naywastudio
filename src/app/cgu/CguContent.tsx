...
const SECTIONS: Record<"fr" | "en", LegalSection[]> = {
  ...
  en: [
    ...
    },
    {
      ...
      content: [
        "The Package Sourcing service is sold per seat. The current pricing grid is published on the Pricing page.",
        "**Account deletion**: the Owner can delete their organization at any time from the console. If other members are active, they keep access to the workspace until the end of the paid period. After that, all of the organization's data is permanently deleted with no possible recovery.",
