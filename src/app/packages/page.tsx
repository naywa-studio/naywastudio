...
const PACKAGES = [
  {
    ...
    description:
      "Léo ou Nora cherchent, trient et scorent des profils publics selon votre brief. Vous récupérez un tableur prêt à l'emploi — avec messages personnalisés si besoin.",
    available: true,
    href: "/tarifs",
    ...
    highlights: ["Recherche web de profils publics", "Export tableur structuré", "Scoring + messages (Nora)"],
  },
  {
    id: "support",
    icon: "💬",
